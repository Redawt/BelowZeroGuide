...
const fcf_check_plugins = [
            ...
            "FROST Region Names Patch.esp",
            "FROST Region Names Patch - Oberland.esp",
            "FROST Region Names Patch - JSRSMMH.esp",
            "FROST Region Names Patch - Drawbridges.esp",
  ...
  function checkFrostPluginOrderAfter(plugin_list){
    ...
    for(let i = offset; i < plugin_list.length-1; i++){
        ...
        const exception_list = [
            "IV_Misc_BoiledWaterBottles.esp", 
            "IV_HC_Perk_Updated.esp",
            "Cat Meat Recipe.esp",
            "SatelliteWorldMap.esp", 
            "PLI_USAF_Satellite_Station_Olivia.esp", 
            "M8r Complex Sorter.esp", "ChillGhouls.esp", 
            "VividWeatherDarkerNWindier.esp", 
            "Nuclear weather.esp",
            "PollutedClimate.esp", 
            "Calamity Weathers.esp", 
            "Calamity Weathers - Far Harbor.esp", 
            "Calamity Weathers - Nuka World.esp", 
            "Calamity Weathers - Winter climate.esp", 
            "PollutedClimate-Winter.esp", 
            "Simple Winter Weather.esp"
        ].concat(fcf_check_plugins);
