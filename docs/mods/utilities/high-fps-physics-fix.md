...
1. Download and install the **[Main File - High FPS Physics Fix OldGen :material-tray-arrow-down:](https://www.nexusmods.com/fallout4/mods/44798?tab=files&file_id=378829&nmm=1)** with your mod manager
    * Make sure to download the file which has ==OldGen== in its name and mentions ==For the game version 1.10.130.0 - 1.10.163.0 and Fallout 4 London==
