...
HD Realistic Blood Textures(Vanilla texture replacer), with bump maps to give blood volume, ripples & bubbles with true object lighting.
...
Retextures the crows to look zombie-ish
